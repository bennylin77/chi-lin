                ...
                case 0:
                  ...
                  readFilePromise = new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_3___default.a(function (resolve, reject) {
                    ...
                    fileReader.onload = function (event) {
                      if (!_this.isJsonString(event.target.result)) reject(event);
                      var result = JSON.parse(event.target.result); //do something here to discard unnecessary data in the file
...
//# sourceMappingURL=1.6fee6de78851da86dbfe.hot-update.js.map